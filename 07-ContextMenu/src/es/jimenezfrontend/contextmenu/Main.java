...
public class Main extends Activity
	...
	protected void onCreate(Bundle savedInstanceState)
		...
		// ///////////////////////////////////////////////////////////////////////////
		// CON LAS SIGUIENTES 2 LÍNEAS LO QUE HACEMOS ES COGER EL VIEW PADRE DE
		// NUESTRA ACTIVIDAD PARA PODER CAMBIAR LA IMAGEN DE FONDO DE LA MISMA
		// ///////////////////////////////////////////////////////////////////////////
		someView = findViewById(R.id.viewContext);
		root = someView.getRootView();
		// ///////////////////////////////////////////////////////////////////////////
		// ESTA INSTRUCCIÓN REQUIERE JELLY BEAN PARA FUNCIONAR
		// ///////////////////////////////////////////////////////////////////////////
		root.setBackground(getResources().getDrawable(R.drawable.background));
		}
